...
| expiry    | [google.protobuf.Timestamp](#google.protobuf.Timestamp) |       | Expiry is the time at which the public key and its associated aliases should be removed from the registrar. If not provided, a default value of 1 day from the time of registration will be used. |
