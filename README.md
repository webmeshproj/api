...
| public_key          | [string](#string)                                       |          | public_key is the public WireGuard key of the node.                   |
| host_public_key     | [string](#string)                                       |          | host_public_key is the public key of the host for p2p connections.    |
...
| host_public_key     | [string](#string)                                                |          | host_public_key is the public key the peer will use for p2p connections.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
