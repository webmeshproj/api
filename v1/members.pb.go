...
var file_v1_members_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x32, 0xa7, 0x02, 0x0a, 0x0a, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x68, 0x69,
	0x70, 0x12, 0x2b, 0x0a, 0x04, 0x4a, 0x6f, 0x69, 0x6e, 0x12, 0x0f, 0x2e, 0x76, 0x31, 0x2e, 0x4a,
	...
	0x00, 0x12, 0x2e, 0x0a, 0x05, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x12, 0x10, 0x2e, 0x76, 0x31, 0x2e,
	0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x76,
	0x31, 0x2e, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x12, 0x32, 0x0a, 0x05, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x12, 0x10, 0x2e, 0x76, 0x31, 0x2e,
...
var file_v1_members_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_v1_members_proto_goTypes = []interface{}{
	...
	(Feature)(0),                      // 10: v1.Feature
	(ClusterStatus)(0),                // 11: v1.ClusterStatus
	(*RaftLogEntry)(nil),              // 12: v1.RaftLogEntry
	(*RaftApplyResponse)(nil),         // 13: v1.RaftApplyResponse
}
var file_v1_members_proto_depIdxs = []int32{
	10, // 0: v1.JoinRequest.features:type_name -> v1.Feature
	4,  // 1: v1.JoinResponse.peers:type_name -> v1.WireGuardPeer
	10, // 2: v1.UpdateRequest.features:type_name -> v1.Feature
	9,  // 3: v1.RaftConfigurationResponse.servers:type_name -> v1.RaftServer
	11, // 4: v1.RaftServer.suffrage:type_name -> v1.ClusterStatus
	0,  // 5: v1.Membership.Join:input_type -> v1.JoinRequest
	2,  // 6: v1.Membership.Update:input_type -> v1.UpdateRequest
	5,  // 7: v1.Membership.Leave:input_type -> v1.LeaveRequest
	12, // 8: v1.Membership.Apply:input_type -> v1.RaftLogEntry
	7,  // 9: v1.Membership.GetRaftConfiguration:input_type -> v1.RaftConfigurationRequest
	1,  // 10: v1.Membership.Join:output_type -> v1.JoinResponse
	3,  // 11: v1.Membership.Update:output_type -> v1.UpdateResponse
	6,  // 12: v1.Membership.Leave:output_type -> v1.LeaveResponse
	13, // 13: v1.Membership.Apply:output_type -> v1.RaftApplyResponse
	8,  // 14: v1.Membership.GetRaftConfiguration:output_type -> v1.RaftConfigurationResponse
