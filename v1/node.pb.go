...
var file_v1_node_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x83, 0x03, 0x0a, 0x04, 0x4e, 0x6f, 0x64,
	...
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x2d, 0x0a, 0x07, 0x47, 0x65,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x00, 0x12, 0x31,
	0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d,
	0x70, 0x74, 0x79, 0x1a, 0x0a, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22,
	0x00, 0x12, 0x4b, 0x0a, 0x10, 0x53, 0x74, 0x61, 0x72, 0x74, 0x44, 0x61, 0x74, 0x61, 0x43, 0x68,
	...
	0x6e, 0x65, 0x6c, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42, 0x61,
...
var file_v1_node_proto_goTypes = []interface{}{
	...
	(*GetNodeRequest)(nil),          // 3: v1.GetNodeRequest
	(*StartDataChannelRequest)(nil), // 4: v1.StartDataChannelRequest
	(*Features)(nil),                // 5: v1.Features
	(*JoinResponse)(nil),            // 6: v1.JoinResponse
	(*MeshNode)(nil),                // 7: v1.MeshNode
	(*NodeList)(nil),                // 8: v1.NodeList
	(*Status)(nil),                  // 9: v1.Status
	(*DataChannelOffer)(nil),        // 10: v1.DataChannelOffer
}
var file_v1_node_proto_depIdxs = []int32{
	...
	3,  // 3: v1.Node.GetNode:input_type -> v1.GetNodeRequest
	0,  // 4: v1.Node.ListNodes:input_type -> google.protobuf.Empty
	0,  // 5: v1.Node.GetStatus:input_type -> google.protobuf.Empty
	4,  // 6: v1.Node.StartDataChannel:input_type -> v1.StartDataChannelRequest
	5,  // 7: v1.Node.GetFeatures:output_type -> v1.Features
	6,  // 8: v1.Node.Join:output_type -> v1.JoinResponse
	0,  // 9: v1.Node.Leave:output_type -> google.protobuf.Empty
	7,  // 10: v1.Node.GetNode:output_type -> v1.MeshNode
	8,  // 11: v1.Node.ListNodes:output_type -> v1.NodeList
	9,  // 12: v1.Node.GetStatus:output_type -> v1.Status
	10, // 13: v1.Node.StartDataChannel:output_type -> v1.DataChannelOffer
