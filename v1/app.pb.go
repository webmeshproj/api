...
var file_v1_app_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x22, 0x10, 0x0a, 0x0e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x22, 0xab, 0x01, 0x0a, 0x0f, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73,
	...
	0x38, 0x01, 0x22, 0x0f, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0xc9, 0x01, 0x0a, 0x0e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x65,
	...
	0xa2, 0x04, 0x0a, 0x09, 0x41, 0x70, 0x70, 0x44, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x12, 0x34, 0x0a,
	...
	,
	...
	0x22, 0x00, 0x30, 0x01, 0x12, 0x34, 0x0a, 0x07, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x12,
	...
	0x6f, 0x6e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x22, 0x00, 0x30, 0x01, 0x12, 0x37, 0x0a, 0x07, 0x50,
	...
	0x74, 0x79, 0x22, 0x00, 0x42, 0x64, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x08,
	0x41, 0x70, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68,
...
var file_v1_app_proto_goTypes = []interface{}{
	...
	(*MetricsRequest)(nil),               // 9: v1.MetricsRequest
	(*MetricsResponse)(nil),              // 10: v1.MetricsResponse
	(*StatusRequest)(nil),                // 11: v1.StatusRequest
	(*StatusResponse)(nil),               // 12: v1.StatusResponse
...
var file_v1_app_proto_depIdxs = []int32{
	...
	5,  // 7: v1.AppDaemon.StartCampfire:input_type -> v1.StartCampfireRequest
	7,  // 8: v1.AppDaemon.LeaveCampfire:input_type -> v1.LeaveCampfireRequest
	17, // 9: v1.AppDaemon.Query:input_type -> v1.QueryRequest
	9,  // 10: v1.AppDaemon.Metrics:input_type -> v1.MetricsRequest
	11, // 11: v1.AppDaemon.Status:input_type -> v1.StatusRequest
	18, // 12: v1.AppDaemon.Subscribe:input_type -> v1.SubscribeRequest
	19, // 13: v1.AppDaemon.Publish:input_type -> v1.PublishRequest
	2,  // 14: v1.AppDaemon.Connect:output_type -> v1.ConnectResponse
	4,  // 15: v1.AppDaemon.Disconnect:output_type -> v1.DisconnectResponse
	6,  // 16: v1.AppDaemon.StartCampfire:output_type -> v1.StartCampfireResponse
	8,  // 17: v1.AppDaemon.LeaveCampfire:output_type -> v1.LeaveCampfireResponse
	20, // 18: v1.AppDaemon.Query:output_type -> v1.QueryResponse
	10, // 19: v1.AppDaemon.Metrics:output_type -> v1.MetricsResponse
	12, // 20: v1.AppDaemon.Status:output_type -> v1.StatusResponse
	21, // 21: v1.AppDaemon.Subscribe:output_type -> v1.SubscriptionEvent
	22, // 22: v1.AppDaemon.Publish:output_type -> google.protobuf.Empty
