...
type ConnectRequest struct {
	...
	AddrType ConnectRequest_AddrType `protobuf:"varint,2,opt,name=addrType,proto3,enum=v1.ConnectRequest_AddrType" json:"addrType,omitempty"`
	// addrs are the join addresses to use to connect to the mesh.
	Addrs []string `protobuf:"bytes,3,rep,name=addrs,proto3" json:"addrs,omitempty"` // Service exposing options?
}
...
type ConnectResponse struct {
	...
	Ipv6 string `protobuf:"bytes,5,opt,name=ipv6,proto3" json:"ipv6,omitempty"` // Anything else?
}
...
var file_v1_app_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x9b, 0x01, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x37, 0x0a, 0x08, 0x61, 0x64, 0x64, 0x72, 0x54, 0x79,
	0x70, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f,
	...
	0x61, 0x64, 0x64, 0x72, 0x73, 0x22, 0x2a, 0x0a, 0x08, 0x41, 0x64, 0x64, 0x72, 0x54, 0x79, 0x70,
	...
	0x02, 0x22, 0x81, 0x01, 0x0a, 0x0f, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73,
	...
	0x09, 0x52, 0x0a, 0x6d, 0x65, 0x73, 0x68, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x12, 0x12, 0x0a,
	...
	0x04, 0x69, 0x70, 0x76, 0x36, 0x22, 0x13, 0x0a, 0x11, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e,
	...
	0x0a, 0x09, 0x43, 0x4f, 0x4e, 0x4e, 0x45, 0x43, 0x54, 0x45, 0x44, 0x10, 0x02, 0x22, 0x52, 0x0a,
	0x12, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x44, 0x48, 0x54, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x10, 0x62, 0x6f, 0x6f, 0x74, 0x73, 0x74, 0x72, 0x61, 0x70,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x62,
	...
	0x6b, 0x22, 0x15, 0x0a, 0x13, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e, 0x63, 0x65, 0x44, 0x48, 0x54,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x23, 0x0a, 0x0f, 0x4c, 0x65, 0x61, 0x76,
	0x65, 0x44, 0x48, 0x54, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x70,
	0x73, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x70, 0x73, 0x6b, 0x22, 0x12, 0x0a,
	0x10, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x44, 0x48, 0x54, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x32, 0x88, 0x04, 0x0a, 0x09, 0x41, 0x70, 0x70, 0x44, 0x61, 0x65, 0x6d, 0x6f, 0x6e, 0x12,
	...
	,
...
var file_v1_app_proto_goTypes = []interface{}{
	...
	(*MetricsRequest)(nil),               // 6: v1.MetricsRequest
	(*MetricsResponse)(nil),              // 7: v1.MetricsResponse
	(*StatusRequest)(nil),                // 8: v1.StatusRequest
	(*StatusResponse)(nil),               // 9: v1.StatusResponse
	(*AnnounceDHTRequest)(nil),           // 10: v1.AnnounceDHTRequest
	(*AnnounceDHTResponse)(nil),          // 11: v1.AnnounceDHTResponse
	(*LeaveDHTRequest)(nil),              // 12: v1.LeaveDHTRequest
	(*LeaveDHTResponse)(nil),             // 13: v1.LeaveDHTResponse
	nil,                                  // 14: v1.MetricsResponse.InterfacesEntry
...
var file_v1_app_proto_depIdxs = []int32{
	0,  // 0: v1.ConnectRequest.addrType:type_name -> v1.ConnectRequest.AddrType
	14, // 1: v1.MetricsResponse.interfaces:type_name -> v1.MetricsResponse.InterfacesEntry
	1,  // 2: v1.StatusResponse.connection_status:type_name -> v1.StatusResponse.ConnectionStatus
	...
	2,  // 5: v1.AppDaemon.Connect:input_type -> v1.ConnectRequest
	4,  // 6: v1.AppDaemon.Disconnect:input_type -> v1.DisconnectRequest
	17, // 7: v1.AppDaemon.Query:input_type -> v1.QueryRequest
	6,  // 8: v1.AppDaemon.Metrics:input_type -> v1.MetricsRequest
	8,  // 9: v1.AppDaemon.Status:input_type -> v1.StatusRequest
	18, // 10: v1.AppDaemon.Subscribe:input_type -> v1.SubscribeRequest
	19, // 11: v1.AppDaemon.Publish:input_type -> v1.PublishRequest
	10, // 12: v1.AppDaemon.AnnounceDHT:input_type -> v1.AnnounceDHTRequest
	12, // 13: v1.AppDaemon.LeaveDHT:input_type -> v1.LeaveDHTRequest
	...
	7,  // 17: v1.AppDaemon.Metrics:output_type -> v1.MetricsResponse
	9,  // 18: v1.AppDaemon.Status:output_type -> v1.StatusResponse
	21, // 19: v1.AppDaemon.Subscribe:output_type -> v1.SubscriptionEvent
	22, // 20: v1.AppDaemon.Publish:output_type -> v1.PublishResponse
	11, // 21: v1.AppDaemon.AnnounceDHT:output_type -> v1.AnnounceDHTResponse
	13, // 22: v1.AppDaemon.LeaveDHT:output_type -> v1.LeaveDHTResponse
