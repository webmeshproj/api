...
// Validate checks the field values on AppSubscribeRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *AppSubscribeRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AppSubscribeRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AppSubscribeRequestMultiError, or nil if none found.
func (m *AppSubscribeRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *AppSubscribeRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, AppSubscribeRequestValidationError{
					field:  "Subscribe",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return AppSubscribeRequestValidationError{
				field:  "Subscribe",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return AppSubscribeRequestMultiError(errors)
	}

	return nil
}

// AppSubscribeRequestMultiError is an error wrapping multiple validation
// errors returned by AppSubscribeRequest.ValidateAll() if the designated
// constraints aren't met.
type AppSubscribeRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AppSubscribeRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AppSubscribeRequestMultiError) AllErrors() []error { return m }

// AppSubscribeRequestValidationError is the validation error returned by
// AppSubscribeRequest.Validate if the designated constraints aren't met.
type AppSubscribeRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AppSubscribeRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AppSubscribeRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AppSubscribeRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AppSubscribeRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AppSubscribeRequestValidationError) ErrorName() string {
	return "AppSubscribeRequestValidationError"
}

// Error satisfies the builtin error interface
func (e AppSubscribeRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAppSubscribeRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AppSubscribeRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AppSubscribeRequestValidationError{}

// Validate checks the field values on AppPublishRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *AppPublishRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on AppPublishRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// AppPublishRequestMultiError, or nil if none found.
func (m *AppPublishRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *AppPublishRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, AppPublishRequestValidationError{
					field:  "Publish",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return AppPublishRequestValidationError{
				field:  "Publish",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return AppPublishRequestMultiError(errors)
	}

	return nil
}

// AppPublishRequestMultiError is an error wrapping multiple validation errors
// returned by AppPublishRequest.ValidateAll() if the designated constraints
// aren't met.
type AppPublishRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m AppPublishRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m AppPublishRequestMultiError) AllErrors() []error { return m }

// AppPublishRequestValidationError is the validation error returned by
// AppPublishRequest.Validate if the designated constraints aren't met.
type AppPublishRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e AppPublishRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e AppPublishRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e AppPublishRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e AppPublishRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e AppPublishRequestValidationError) ErrorName() string {
	return "AppPublishRequestValidationError"
}

// Error satisfies the builtin error interface
func (e AppPublishRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sAppPublishRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = AppPublishRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = AppPublishRequestValidationError{}
