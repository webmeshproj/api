...
// DeepCopyInto supports using AppSubscribeRequest within kubernetes types, where deepcopy-gen is used.
func (in *AppSubscribeRequest) DeepCopyInto(out *AppSubscribeRequest) {
	p := proto.Clone(in).(*AppSubscribeRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppSubscribeRequest. Required by controller-gen.
func (in *AppSubscribeRequest) DeepCopy() *AppSubscribeRequest {
	if in == nil {
		return nil
	}
	out := new(AppSubscribeRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AppSubscribeRequest. Required by controller-gen.
func (in *AppSubscribeRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}

// DeepCopyInto supports using AppPublishRequest within kubernetes types, where deepcopy-gen is used.
func (in *AppPublishRequest) DeepCopyInto(out *AppPublishRequest) {
	p := proto.Clone(in).(*AppPublishRequest)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppPublishRequest. Required by controller-gen.
func (in *AppPublishRequest) DeepCopy() *AppPublishRequest {
	if in == nil {
		return nil
	}
	out := new(AppPublishRequest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new AppPublishRequest. Required by controller-gen.
func (in *AppPublishRequest) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
