...
type CampfireMessage struct {
	...
	Lufrag string `protobuf:"bytes,3,opt,name=lufrag,proto3" json:"lufrag,omitempty"`
	// The sending password of the message.
	Lpwd string `protobuf:"bytes,4,opt,name=lpwd,proto3" json:"lpwd,omitempty"`
	// The receiving ufrag of the message.
	Rufrag string `protobuf:"bytes,5,opt,name=rufrag,proto3" json:"rufrag,omitempty"`
	// The receiving password of the message.
	Rpwd string `protobuf:"bytes,6,opt,name=rpwd,proto3" json:"rpwd,omitempty"`
...
func (x *CampfireMessage) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_v1_campfire_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x92, 0x02, 0x0a, 0x0f, 0x43, 0x61, 0x6d, 0x70, 0x66, 0x69, 0x72,
	...
	0x06, 0x6c, 0x75, 0x66, 0x72, 0x61, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6c,
	0x75, 0x66, 0x72, 0x61, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x70, 0x77, 0x64, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6c, 0x70, 0x77, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x75, 0x66,
	0x72, 0x61, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x75, 0x66, 0x72, 0x61,
	0x67, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x70, 0x77, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x72, 0x70, 0x77, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x07, 0x20,
