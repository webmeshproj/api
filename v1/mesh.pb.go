...
var file_v1_mesh_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa3, 0x01, 0x0a, 0x04, 0x4d, 0x65, 0x73,
	...
	0x76, 0x31, 0x2e, 0x4d, 0x65, 0x73, 0x68, 0x47, 0x72, 0x61, 0x70, 0x68, 0x22, 0x00, 0x42, 0x61,
...
var file_v1_mesh_proto_depIdxs = []int32{
	...
	1, // 2: v1.Mesh.GetMeshGraph:input_type -> google.protobuf.Empty
	2, // 3: v1.Mesh.GetNode:output_type -> v1.MeshNode
	3, // 4: v1.Mesh.ListNodes:output_type -> v1.NodeList
	4, // 5: v1.Mesh.GetMeshGraph:output_type -> v1.MeshGraph
