...
var file_v1_plugin_proto_rawDesc = []byte{
	...
	0x79, 0x52, 0x03, 0x6c, 0x6f, 0x67, 0x22, 0x58, 0x0a, 0x05, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12,
	...
	0x54, 0x59, 0x5f, 0x57, 0x41, 0x54, 0x43, 0x48, 0x10, 0x03, 0x2a, 0x7b, 0x0a, 0x0a, 0x57, 0x61,
	...
	0x48, 0x41, 0x4e, 0x47, 0x45, 0x10, 0x03, 0x32, 0xaa, 0x02, 0x0a, 0x06, 0x50, 0x6c, 0x75, 0x67,
	...
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e,
	0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x05, 0x53, 0x74, 0x6f, 0x72, 0x65,
	...
	0x70, 0x70, 0x6c, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x47,
	...
	0x75, 0x74, 0x68, 0x65, 0x6e, 0x74, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2b, 0x0a, 0x04, 0x45, 0x6d, 0x69, 0x74, 0x12,
...
var file_v1_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_v1_plugin_proto_goTypes = []interface{}{
	...
	nil,                            // 8: v1.AuthenticationRequest.HeadersEntry
...
var file_v1_plugin_proto_depIdxs = []int32{
	...
	9,  // 1: v1.PluginConfiguration.config:type_name -> google.protobuf.Struct
	8,  // 2: v1.AuthenticationRequest.headers:type_name -> v1.AuthenticationRequest.HeadersEntry
	10, // 3: v1.StoreLogRequest.log:type_name -> v1.RaftLogEntry
	1,  // 4: v1.Event.type:type_name -> v1.WatchEvent
	11, // 5: v1.Event.node:type_name -> v1.MeshNode
	12, // 6: v1.Plugin.GetInfo:input_type -> google.protobuf.Empty
	...
	7,  // 10: v1.Plugin.Emit:input_type -> v1.Event
	2,  // 11: v1.Plugin.GetInfo:output_type -> v1.PluginInfo
	12, // 12: v1.Plugin.Configure:output_type -> google.protobuf.Empty
	13, // 13: v1.Plugin.Store:output_type -> v1.RaftApplyResponse
	5,  // 14: v1.Plugin.Authenticate:output_type -> v1.AuthenticationResponse
	12, // 15: v1.Plugin.Emit:output_type -> google.protobuf.Empty
