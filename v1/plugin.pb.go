...
var file_v1_plugin_proto_rawDesc = []byte{
	...
	0x6a, 0x0a, 0x10, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c,
	...
	0x4c, 0x49, 0x54, 0x59, 0x5f, 0x41, 0x55, 0x54, 0x48, 0x10, 0x02, 0x32, 0xf6, 0x01, 0x0a, 0x06,
...
var file_v1_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_v1_plugin_proto_goTypes = []interface{}{
	...
	nil,                           // 4: v1.AuthenticationRequest.HeadersEntry
	(*anypb.Any)(nil),             // 5: google.protobuf.Any
	(*emptypb.Empty)(nil),         // 6: google.protobuf.Empty
	(*RaftLogEntry)(nil),          // 7: v1.RaftLogEntry
	(*RaftApplyResponse)(nil),     // 8: v1.RaftApplyResponse
}
var file_v1_plugin_proto_depIdxs = []int32{
	0, // 0: v1.PluginInfo.capabilities:type_name -> v1.PluginCapability
	5, // 1: v1.PluginConfiguration.config:type_name -> google.protobuf.Any
	4, // 2: v1.AuthenticationRequest.headers:type_name -> v1.AuthenticationRequest.HeadersEntry
	6, // 3: v1.Plugin.GetInfo:input_type -> google.protobuf.Empty
	2, // 4: v1.Plugin.Configure:input_type -> v1.PluginConfiguration
	7, // 5: v1.Plugin.Store:input_type -> v1.RaftLogEntry
	3, // 6: v1.Plugin.Authenticate:input_type -> v1.AuthenticationRequest
	1, // 7: v1.Plugin.GetInfo:output_type -> v1.PluginInfo
	6, // 8: v1.Plugin.Configure:output_type -> google.protobuf.Empty
	8, // 9: v1.Plugin.Store:output_type -> v1.RaftApplyResponse
	6, // 10: v1.Plugin.Authenticate:output_type -> google.protobuf.Empty
