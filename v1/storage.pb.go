...
var file_v1_storage_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x32, 0xaf, 0x01, 0x0a, 0x07, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x30,
	...
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76, 0x65, 0x6e, 0x74,
	0x22, 0x00, 0x30, 0x01, 0x42, 0x68, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x0c,
	0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x28,
...
var file_v1_storage_proto_depIdxs = []int32{
	...
	1, // 2: v1.Storage.Query:input_type -> v1.QueryRequest
	5, // 3: v1.Storage.Publish:input_type -> v1.PublishRequest
	3, // 4: v1.Storage.Subscribe:input_type -> v1.SubscribeRequest
	2, // 5: v1.Storage.Query:output_type -> v1.QueryResponse
	6, // 6: v1.Storage.Publish:output_type -> v1.PublishResponse
	4, // 7: v1.Storage.Subscribe:output_type -> v1.SubscriptionEvent
